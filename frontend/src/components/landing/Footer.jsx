      ...
      <div className="w-full px-6 sm:px-10 md:px-16 lg:px-24 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-x-8 gap-y-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="flex flex-col gap-4">
              {['Tentang Kami', 'Tim', 'Kontak'].map((item) => (
                <a key={item} href="#" className="text-sm text-slate-400 hover:text-primary-400 hover:translate-x-1 transition-all inline-block w-fit">
                  {item}
                </a>
              ))}
            </div>
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="flex flex-col gap-4">
              {['Demo', 'Dokumentasi', 'Blog', 'Bantuan'].map((item) => (
                <a key={item} href="#" className="text-sm text-slate-400 hover:text-primary-400 hover:translate-x-1 transition-all inline-block w-fit">
                  {item}
                </a>
              ))}
